  ...
  <div class="max-w-7xl mx-auto">
    <div class="flex flex-col md:flex-row justify-between items-center">
      <div class="mb-6 md:mb-0 text-center md:text-left">
        <h2 class="text-2xl font-bold text-gray-900 mb-1">Ranjan</h2>
        <p class="text-lg text-gray-600 mb-2">Full Stack Developer</p>
    ...
    <div class="mt-8 pt-8 border-t border-gray-300 text-center text-sm">
      <p>&copy; <span id="year"></span> Ranjan Kashyap. All rights reserved. Built with passion and ☕</p>
    </div>
  </div>
</footer>
`;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  wrapper.innerHTML = footerLightHTML;
